...
import { X, Mic, Square, Download } from 'lucide-react';
...
export function SetRecordingModal({ isOpen, onClose }: SetRecordingModalProps) {
  ...
  return (
    <div className="fixed inset-0 z-[9990] flex items-center justify-center p-4 bg-black/85 backdrop-blur-md select-none font-mono">
      <motion.div
