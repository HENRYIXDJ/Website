...
export const getSessionImage = (title: string, artworkUrl?: string) => {
  ...
  if (!title) return getStorageUrl('/Mixes/Knight%20Club/Mix%20Artwork/Knight%20Club%20Track%20Artwork%20Session%201.jpg');
  if (title.includes('Knight Club') && title.includes('Session 1')) return getStorageUrl('/Mixes/Knight%20Club/Mix%20Artwork/Knight%20Club%20Track%20Artwork%20Session%201.jpg');
  if (title.includes('Knight Club') && title.includes('Session 2')) return getStorageUrl('/Mixes/Knight%20Club/Mix%20Artwork/Knight%20Club%20Track%20Artwork%20Session%202.jpg');
  if (title.includes('Knight Club') && title.includes('Session 3')) return getStorageUrl('/Mixes/Knight%20Club/Mix%20Artwork/Knight%20Club%20Track%20Artwork%20Session%203.jpg');
  if (title.includes('Knight Club') && title.includes('Session 4')) return getStorageUrl('/Mixes/Knight%20Club/Mix%20Artwork/Knight%20Club%20Track%20Artwork%20Session%204.jpg');
  if (title.includes('Knight Club') && title.includes('Session 5')) return getStorageUrl('/Mixes/Knight%20Club/Mix%20Artwork/Knight%20Club%20Track%20Artwork%20Session%205.jpg');
  ...
  if (title.includes('Session 1')) return getStorageUrl('/Mixes/Knight%20Club/Mix%20Artwork/Knight%20Club%20Track%20Artwork%20Session%201.jpg');
  if (title.includes('Session 2')) return getStorageUrl('/Mixes/Knight%20Club/Mix%20Artwork/Knight%20Club%20Track%20Artwork%20Session%202.jpg');
  if (title.includes('Session 3')) return getStorageUrl('/Mixes/Knight%20Club/Mix%20Artwork/Knight%20Club%20Track%20Artwork%20Session%203.jpg');
  if (title.includes('Session 4')) return getStorageUrl('/Mixes/Knight%20Club/Mix%20Artwork/Knight%20Club%20Track%20Artwork%20Session%204.jpg');
  if (title.includes('Session 5')) return getStorageUrl('/Mixes/Knight%20Club/Mix%20Artwork/Knight%20Club%20Track%20Artwork%20Session%205.jpg');
