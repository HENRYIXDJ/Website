 ...
 * lib/midiPresets.ts
 *
 * Universal Pre-configured MIDI mapping schemas for physical DJ hardware controllers:
 * - Pioneer XDJ-RX3 Hardware (User-Owned)
 * - Pioneer DDJ-400 / DDJ-FLX4 Hardware (User-Owned)
 * - Pioneer CDJ-3000 / CDJ-2000NXS2 Hardware
 * - Pioneer DDJ-1000 / DDJ-800 / DDJ-FLX6 Hardware
 * - Denon DJ Prime 4 / SC6000 / MC7000 Hardware
 * - Native Instruments Traktor Kontrol (S2 / S4 / X1 / Z2)
 * - Numark Mixtrack Pro FX / Platinum FX
 * - Hercules Inpulse / Reloop Mixon Series
...
// Helper builder for Pioneer DDJ-400 / DDJ-FLX4 2-Deck hardware controller (Maps to Deck 1 & Deck 2)
function createDDJ400ChannelMap(deckId: 1 | 2, ch: number): MIDIMappingItem[] {
  const altCh = ch + 7;
  const ch1Based = ch + 1; // Alias for 1-based channel mapping
  return [
    // Transport Play/Cue aliases across 0-based and 1-based MIDI channels
    { id: `d${deckId}_play_1`, type: 'PLAY', channel: ch, status: 'noteon', number: 11, deckId },
    { id: `d${deckId}_play_1b`, type: 'PLAY', channel: ch1Based, status: 'noteon', number: 11, deckId },
    ...
    { id: `d${deckId}_cue_1b`, type: 'CUE', channel: ch1Based, status: 'noteon', number: 12, deckId },
    ...
    { id: `d${deckId}_pitch_14bit_alt`, type: 'PITCH_SLIDER_14BIT', channel: ch1Based, status: 'cc', number: 0, lsbNumber: 32, is14Bit: true, deckId },
    ...
    { id: `d${deckId}_trim_1b`, type: 'TRIM', channel: ch1Based, status: 'cc', number: 16, deckId },
    ...
    { id: `d${deckId}_eq_hi_1b`, type: 'EQ_HIGH', channel: ch1Based, status: 'cc', number: 7, deckId },
    ...
    { id: `d${deckId}_eq_mid_1b`, type: 'EQ_MID', channel: ch1Based, status: 'cc', number: 11, deckId },
    ...
    { id: `d${deckId}_eq_low_1b`, type: 'EQ_LOW', channel: ch1Based, status: 'cc', number: 15, deckId },
    ...
    { id: `d${deckId}_filter_1b`, type: 'FILTER', channel: ch1Based, status: 'cc', number: 23, deckId },
    ...
    { id: `d${deckId}_vol_1b`, type: 'VOLUME', channel: ch1Based, status: 'cc', number: 19, deckId },
...
export const PRESET_XDJ_RX3: ControllerPreset = {
  id: 'xdj_rx3_hardware',
  name: 'Pioneer XDJ-RX3 Hardware',
  matchNames: ['xdj-rx3', 'rx3', 'xdj'],
  mappings: [
...
export const PRESET_DDJ400: ControllerPreset = {
  id: 'ddj_400_hardware',
  name: 'Pioneer DDJ-400 / DDJ-FLX4 Hardware',
  matchNames: ['ddj-400', 'ddj-flx4', 'flx4', 'ddj-400/flx4', 'ddj'],
  mappings: [
...
export const PRESET_CDJ3000: ControllerPreset = {
  ...
  name: 'Pioneer CDJ-3000 / CDJ-2000NXS2 Hardware',
...
export const PRESET_DDJ1000: ControllerPreset = {
  ...
  name: 'Pioneer DDJ-1000 / DDJ-800 / DDJ-FLX6 Hardware',
...
export const PRESET_DENON_PRIME: ControllerPreset = {
  id: 'denon_prime_hardware',
  name: 'Denon DJ Prime 4 / SC6000 / MC7000',
  matchNames: ['denon', 'prime', 'sc6000', 'mc7000'],
  mappings: [
    ...createHardwareChannelMap(1, 0),
    ...createHardwareChannelMap(2, 1),
    ...createHardwareChannelMap(3, 2),
    ...createHardwareChannelMap(4, 3),
    { id: 'crossfader', type: 'CROSSFADER', channel: 0, status: 'cc', number: 6 }
  ]
};

export const PRESET_TRAKTOR_KONTROL: ControllerPreset = {
  id: 'traktor_kontrol_hardware',
  name: 'Native Instruments Traktor Kontrol (S2 / S4 / X1)',
  matchNames: ['traktor', 'kontrol', 's2', 's4', 'x1', 'z2'],
  mappings: [
    ...createHardwareChannelMap(1, 0),
    ...createHardwareChannelMap(2, 1),
    ...createHardwareChannelMap(3, 2),
...
export const PRESET_NUMARK_MIXTRACK: ControllerPreset = {
  id: 'numark_mixtrack',
  name: 'Numark Mixtrack Pro FX / Platinum FX',
...
export const PRESET_HERCULES_INPULSE: ControllerPreset = {
  id: 'hercules_inpulse',
  name: 'Hercules Inpulse / Reloop Series',
  matchNames: ['hercules', 'inpulse', 'reloop', 'mixon'],
  mappings: [
    ...createHardwareChannelMap(1, 0),
    ...createHardwareChannelMap(2, 1),
    { id: 'crossfader', type: 'CROSSFADER', channel: 0, status: 'cc', number: 31 }
